# Security analysis examples (Phase 2)

This document provides few-shot examples for analyzing code for security vulnerabilities during the scan phase. Each example shows the input code, the analysis process, and the expected finding output. Read this when you need guidance on how to reason about a file during a scan.
